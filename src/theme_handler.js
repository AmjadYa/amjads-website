...
/* =====================
  ...
  /* =====================
     8) Function to Attach the Toggle Event
     ===================== */
  /*
     We'll call this AFTER header.html is inserted into the DOM.
     If the button doesn't exist yet, we won't find it.
  */
  function setupThemeToggle() {
    ...
    if (!toggleButton) return; // if no button found, abort
  
    // Set correct button text initially
    toggleButton.textContent = isMonochrome
      ? 'Randomize Colours'
      : 'Monochrome Mode';
  ...
  /* 
     Expose setupThemeToggle() globally so we can call it after fetch('header.html')
  */
